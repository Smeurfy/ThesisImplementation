...
public class PlayerShootTest : MonoBehaviour
{
    ...
    [SerializeField] public Weapon weaponBeingHeld;
    ...
    private BulletManagerTest currentBulletManager;
    ...
    void Start()
    {
        ...
        gameObject.GetComponentInParent<ThrowItemTest>().OnPlayerThrow += DroppedThrowable;
    }
